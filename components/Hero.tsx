  ...
  return (
    <header className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        {/* Glowing Orbs */}
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[500px] bg-[radial-gradient(circle_at_30%_30%,rgba(212,175,55,0.2),transparent_60%)] blur-[60px] animate-float opacity-50"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[500px] bg-[radial-gradient(circle_at_30%_30%,rgba(0,51,102,0.15),transparent_60%)] blur-[60px] animate-float opacity-40" style={{ animationDelay: '3s' }}></div>
        ...
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-primary/20 rounded-full animate-spin-slow"></div>
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-12">
        ...
        <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-slate-900 dark:text-white leading-tight animate-slide-up opacity-0">
          ...
          <span className="block text-xl md:text-3xl lg:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-gold via-gold-dark to-gold-light mt-4 font-mono tracking-[0.3em] font-black uppercase">
            NPC
          </span>
        </h1>
        
        <p className="font-body text-lg md:text-2xl text-slate-700 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed animate-fade-in opacity-0" style={{ animationDelay: '0.4s' }}>
