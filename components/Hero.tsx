  ...
  return (
    <header className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-12">
        ...
        <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-slate-900 dark:text-white leading-[0.9] animate-slide-up">
          LEGACY <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-yellow-500 to-amber-700">
            UNBOUND
          </span>
        </h1>
        ...
        <div className="pt-16 flex flex-col items-center gap-8 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <div className="flex flex-wrap justify-center gap-6">
            <a href="#about" className="group relative inline-flex items-center justify-center px-10 py-5 text-xs font-black uppercase tracking-[0.3em] text-white transition-all duration-300 bg-primary rounded-full hover:shadow-[0_0_30px_rgba(217,119,6,0.5)] transform hover:-translate-y-1">
              Start Transformation
            </a>
            <a href="#phases" className="group inline-flex items-center justify-center px-10 py-5 text-xs font-black uppercase tracking-[0.3em] text-slate-900 dark:text-white transition-all duration-300 bg-transparent border-2 border-slate-200 dark:border-white/10 rounded-full hover:border-primary">
              View Roadmap
            </a>
          </div>
