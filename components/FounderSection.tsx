...
const FounderSection: React.FC<FounderSectionProps> = ({ onExplore }) => {
  return (
    <section id="directors-preview" className="relative py-24 bg-black overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="space-y-8 animate-fade-in">
          ...
          <div className="pt-6">
            <button 
              onClick={onExplore}
              className="group inline-flex items-center gap-3 px-10 py-5 bg-primary text-white text-xs font-black uppercase tracking-[0.3em] rounded-full hover:shadow-[0_0_40px_rgba(217,119,6,0.4)] transition-all transform hover:-translate-y-1"
            >
